var ROUGH_WING_BRUSH_SETTINGS = {
  ...
  voronoi: {
    brushName: "pencil2",
    color: "#090907",
    initialBrushLoad: 0.5,    // 初始下筆墨水量
    brushLoad: [0.72, 1.08],  // 每次畫線時的墨水隨機範圍
    strokeWeight: [0.48, 0.88], // 翅脈的粗細變化範圍
    repeatChance: 0.22,       // 同一條線重複描繪兩次的機率 (增加手繪感)
    shapeRoughness: 0.08,     // 線條抖動程度
    pressureBase: [0.48, 0.82], // 基礎壓力 (決定透明度與粗細)
    pressureTaper: [0.08, 0.28], // 頭尾兩端壓力衰減量 (收筆效果)
  ...
  // 斑點與眼紋 (對應 drawRoughWingPatternDot 等)
  patternDot: {
    brushName: "marker1",
    brushLoad: [0.12, 0.22],
  ...
  specular: {
    brushName: "marker1",
    darkBrushLoad: 0.13,        // 深色反光的墨水負載
    darkStrokeWeight: 0.8,      // 深色反光的粗細
    brightBrushLoad: 0.09,      // 高亮的墨水負載
    brightStrokeWeight: 0.46,   // 高亮的粗細
    brushLoadJitter: [0.85, 1.15], // 墨水量的隨機抖動倍率
  ...
  radialWash: {
    ...
    fillTextureScale: [0.02, 0.08],  // 填充紋理的縮放大小
    shapeRoughness: 0.16,
